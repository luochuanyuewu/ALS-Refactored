...
#include "AlsSimpleCharacterExample.generated.h"
...
class ALSEXTRAS_API AAlsSimpleCharacterExample : public AAlsSimpleCharacter
{
	GENERATED_BODY()
...
public:
	AAlsSimpleCharacterExample(const FObjectInitializer& ObjectInitializer);
